...
public class UserService {
    ...
    public User getById(int id) {
        ...
        log.info(
                "Пользователь с id {} отправлен.", id
        );
    ...
    public User deleteById(int id) {
        if (!userStorage.getUsers().containsKey(id)) {
            throw new ObjectNotFoundException(
                    "Пользователь не найден, удаление не возможно."
            );
        }
        log.info(
                "Пользователь с id {} удален.", id
        );
    ...
    public List<User> addFriendship(int firstId, int secondId) {
        if (!userStorage.getUsers().containsKey(firstId) || !userStorage.getUsers().containsKey(secondId)) {
            throw new ObjectNotFoundException(String.format(
                    "Пользователя с id %d или %d не существует.", firstId, secondId
            ));
        }
        ...
        log.info(
                "Пользователи {} и {} теперь друзья.", userStorage.getById(firstId).getName(),
    ...
    public List<User> removeFriendship(int firstId, int secondId) {
        ...
        log.info(
                "Пользователи {} и {} больше не друзья.", userStorage.getById(firstId).getName(),
                userStorage.getById(secondId).getName()
        );
        return Arrays.asList(userStorage.getById(firstId), userStorage.getById(secondId));
    }
    ...
    public List<User> getFriendsListById(int id) {
        ...
        log.info(
                "Запрос получения списка друзей пользователя {} выполнен.", userStorage.getById(id).getName()
        );
    ...
    public List<User> getCommonFriendsList(int firstId, int secondId) {
        ...
        log.info(
                "Список общих друзей {} и {} отправлен.", user.getName(), otherUser.getName()
        );
