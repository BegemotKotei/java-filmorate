...
public class FilmService {
    ...
    public Film addLike(int filmId, int userId) {
        ...
        log.info(
                "Пользователь {} поставил лайк фильму {}.", userId, filmId
        );
    ...
    public Film removeLike(int filmId, int userId) {
        ...
        if (!filmStorage.getById(filmId).getUsersLikes().contains(userId)) {
            throw new ObjectNotFoundException(
                    "Лайк от пользователя отсутствует."
            );
        }
        filmStorage.getById(filmId).getUsersLikes().remove(userId);
        log.info(
                "Пользователь {} удалил лайк к фильму {}.", userId, filmId
        );
    ...
    public List<Film> getBestFilms(int count) {
        log.info(
                "Список популярных фильмов отправлен."
        );
